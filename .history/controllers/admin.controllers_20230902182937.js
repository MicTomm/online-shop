...
async function updateOrder(req, res, next){
    ...
    try {
        ...
        console.log('ERROR - admin.controllers.js => updateOrder() -> updateOrderStatus(orderId, orderStatus)');
        return next(error);
    }
    
    let orderDoc;
    try {
        orderDoc = await Order.fetchById(orderId);
    } catch (error) {
        console.log('ERROR - admin.controllers.js => updateOrder() -> fetchById(orderId)');
        return next(error);
    }
